def bibliography():
    ...
    import json
    with open(r"C:\Users\Eirini\Documents\Digital HUmanities\WS_2020_MRomanov\HW070172\Lesson6\bibliography.json", "w", encoding="utf8") as f3:
        json.dump(bibliodict, f3)
